...
## This is a modified version of hierarchical.py that returns a distance matrix
## See https://stackoverflow.com/questions/26851553/sklearn-agglomerative-clustering-linkage-matrix
